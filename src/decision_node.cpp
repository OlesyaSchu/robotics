...
private:
    ...
    int current_state, previous_state; // TODO: which state exactly?
    int frequency;
...
decision_node()
{
    ...
    // TODO: set it after we will get current_position value
    base_position.x = 0;
    base_position.y = 0;
    base_orientation = 0; 

    // TODO: is it the current position?
    origin_position.x = 0; 
    origin_position.y = 0;
    ...
    if ( init_localization )
    {
        ...
        switch ( current_state )
        {
            ...
            case observing_the_person:
                // TODO: check if the tracked person in max_base_distance
                // new_person_position - base_position > max_base_distance
...
void process_observing_the_person()
{
    ...
    if ( state_has_changed )
    {
        ...
        getchar();
        frequency = 0;
        if (distancePoints(new_person_position, base_position) > max_base_distance) {
            current_state = waiting_for_a_person;
