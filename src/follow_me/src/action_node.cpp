...
void compute_rotation()
{
    ...
    cond_rotation = fabs(error_rotation) > error_rotation_threshold ; //cond_rotation is used to control if we stop or not the pid TO COMPLETE. take care that rotation_to_do could be negative
    ...
    if ( cond_rotation )
    {
        ...
        error_integral_rotation = error_rotation + error_previous_rotation;
...
void compute_translation()
{
    ...
    cond_translation = fabs(error_translation) > error_translation_threshold; // cond_translation is used to control if we stop or not the pid for translation
    ...
    if ( cond_translation )
    {
        ...
        error_integral_translation = error_translation - error_previous_translation;
...
void combine_rotation_and_translation()
{
    ...
    translation_speed = translation_speed * coef_translation; // use here translation_speed and coef_rotation
